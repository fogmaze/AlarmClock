...
import com.fogmaze.alarm.data.Prefs.Companion.MAX_PREALARM_VOLUME
...
import com.fogmaze.alarm.util.subscribeIn
...
class VolumePreference(mContext: Context, attrs: AttributeSet) : Preference(mContext, attrs) {
  ...
  /** Called from [com.fogmaze.alarm.presenter.SettingsFragment.onPause] */
  fun onPause() {
    stopMasterSample()
    stopPrealarmSample()
  }
